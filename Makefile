...
SERVICES := user-service seller-service product-service order-service notification-service review-service payment-service chat-service dispute-service admin-service promotion-service recommendation-service delivery-service ecocash-service property-service api-gateway
...
migrate-up: ## Run all migrations (or: make migrate-up svc=user-service)
	@if [ -z "$(svc)" ]; then \
		for s in user-service seller-service product-service order-service notification-service review-service payment-service chat-service dispute-service admin-service promotion-service recommendation-service delivery-service ecocash-service property-service; do \
			echo "\n▶ Migrating $$s..."; \
